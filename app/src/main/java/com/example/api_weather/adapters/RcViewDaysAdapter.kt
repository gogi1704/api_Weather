...
class RcViewDaysAdapter :
    ListAdapter<WeatherModel, RcViewDaysAdapter.WeatherViewHolder>(ComparatorDays()) {
    ...
    class WeatherViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(item: WeatherModel) {
            with(binding) {
                ...
                textViewCondition.text = "max / min"
                textViewTemp.text = "${item.maxTemp}°C / ${item.minTemp}°C"
...
class ComparatorDays() : DiffUtil.ItemCallback<WeatherModel>() {
